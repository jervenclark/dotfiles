...

;;;### (autoloads nil "bwonsamdi-theme" "bwonsamdi-theme.el" (0
;;;;;;  0 0 0))
;;; Generated autoloads from bwonsamdi-theme.el

(when load-file-name (add-to-list 'custom-theme-load-path (file-name-as-directory (file-name-directory load-file-name))))

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "bwonsamdi-theme" '("bwonsamdi")))


(defun bwonsamdi-theme-color (name)
  "Read the color NAME (e.g. color5) from the X resources."
  (x-get-resource name ""))

(deftheme bwonsamdi "~/.Xresources as a theme")

(let* ((foreground (bwonsamdi-theme-color "foreground"))
       (background (bwonsamdi-theme-color "background"))
       (black (bwonsamdi-theme-color "color0"))
       (red (bwonsamdi-theme-color "color1"))
       (green (bwonsamdi-theme-color "color2"))
       (yellow (bwonsamdi-theme-color "color3"))
       (blue (bwonsamdi-theme-color "color4"))
       (magenta (bwonsamdi-theme-color "color5"))
       (cyan (bwonsamdi-theme-color "color6"))
       (gray (bwonsamdi-theme-color "color7"))
       (light-gray (bwonsamdi-theme-color "color8"))
       (light-red (bwonsamdi-theme-color "color9"))
       (light-green (bwonsamdi-theme-color "color10"))
       (light-yellow (bwonsamdi-theme-color "color11"))
       (light-blue (bwonsamdi-theme-color "color12"))
       (light-magenta (bwonsamdi-theme-color "color13"))
       (light-cyan (bwonsamdi-theme-color "color14"))
       (white (bwonsamdi-theme-color "color15")))
...
(provide-theme 'bwonsamdi)

;;; bwonsamdi-theme.el ends here
